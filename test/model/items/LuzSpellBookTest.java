...
public class LuzSpellBookTest extends AbstractTestItem{

    private LuzSpellBook spellbook;
    private LuzSpellBook wrongSpellbook;
    ...
    public void setTestItem() {
        expectedName = "Common luz spell book";
        expectedPower = 8;
        expectedMinRange = 2;
        expectedMaxRange = 4;
        spellbook = new LuzSpellBook(expectedName, expectedPower, expectedMinRange, expectedMaxRange);
    }
    ...
    public void setWrongRangeItem() {
        wrongSpellbook = new LuzSpellBook("Wrong spellbook", 10, 1, 1);
    }
    ...
    public void checkResistance(){
        ...
        OscuridadSpellBook test = new OscuridadSpellBook("test",10,2,3);
        getTestItem().receiveAttackFromOscuridadSpellBook(test);
    ...
    public void checkNeutral(){
        ...
        getTestUnit().equipItem(getTestItem());
        assertEquals(getTestItem(),getTestUnit().getEquippedItem());
        LuzSpellBook item = new LuzSpellBook("test",10,2,3);
        getTestItem().receiveAttackFromLuzSpellBook(item);
